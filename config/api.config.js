...
module.exports = {
  ...
  clientId: '767d806e-0654-40b0-a24c-fb31b384d39f',
  obfuscatedClientSecret: 'U2FsdGVkX19yjJgfl9ux1LhonrbRkBOx5UDzFFWag8OzsVBQTSvctz9hniLDdbBbgClZZeTtFZej9M6xgSvWJg==',

  // The redirectUri is the URL that the user will be redirected to after they have authenticated with Microsoft Graph API.
  // Likewise, you would not need to change redirectUri if you are using your personal Microsoft account with OneDrive International.
  redirectUri: 'https://onedrive-vercel-index-umber-alpha.vercel.app/',
